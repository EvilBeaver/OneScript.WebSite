...
Процедура ПриСозданииОбъекта()
	СоздатьДистрибутив("exe", "Windows Installer (exe)")
		.ДобавитьФайл(Архитектуры.Арх86, Архитектуры.Арх86.Каталог(), "*.exe")
		.ДобавитьФайл(Архитектуры.Арх64, Архитектуры.Арх64.Каталог(), "*.exe");

	СоздатьДистрибутив("zip", "Zip-архив")
		.ДобавитьФайл(Архитектуры.Арх86, Архитектуры.Арх86.Каталог(), "OneScript-1.*.zip")
		.ДобавитьФайл(Архитектуры.Арх64, Архитектуры.Арх64.Каталог(), "OneScript-1.*.zip")
	...
	СоздатьДистрибутив("rpm", "Fedora/CentOS (rpm)")
		.ДобавитьФайл(Архитектуры.Арх64, Архитектуры.Арх64.Каталог(), "*.rpm");

	СоздатьДистрибутив("deb", "Debian/Ubuntu (deb)")
		.ДобавитьФайл(Архитектуры.Арх64, Архитектуры.Арх64.Каталог(), "*.deb");
	
	СоздатьДистрибутив("vsix", "Расширение VSCode")
		.ДобавитьФайл(Архитектуры.Арх64, Архитектуры.Арх64.Каталог(), "*.vsix")
		.ДобавитьФайл(Архитектуры.Арх86, Архитектуры.Арх86.Каталог(), "*.vsix");
