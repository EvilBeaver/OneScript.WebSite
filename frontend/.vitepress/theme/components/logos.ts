export const baseLogos = [
  { src: '/logos/t-bank.png', srcDark: '/logos/t-bank-w.png', name: 'Т-Банк', url: 'https://www.tbank.ru/' },
  { src: '/logos/OzonTech_light.png', srcDark: '/logos/OzonTech_dark.png', name: 'OZON Tech', url: 'https://ozon.tech/' },
  { src: '/logos/BCS-MI.png', srcDark: '/logos/BCS-MI-dark.png', name: 'БКС Мир инвестиций', url: 'https://bcs.ru/' },
...
export const gridLogos = baseLogos;
