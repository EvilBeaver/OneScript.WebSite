...
1Script написан на языке C# и работает на платформе .NET Актуальная версия платформы - NET8. По мере необходимости, версия платформы поднимается до актуальных.
