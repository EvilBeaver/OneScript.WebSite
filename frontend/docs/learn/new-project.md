...
Большинство проектов не состоят из единственного файла, а разбиты на разные модули. OneScript может загружать другие скрипты в виде двух сущностей: классы и модули
