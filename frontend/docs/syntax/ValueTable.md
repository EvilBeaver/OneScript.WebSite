...
* **index**: Число - Индекс позиции куда будет произведена вставка.
            Если индекс вне размера Таблицы значений, строка добавляется в конец
...
* **columnNames**: Строка - Список имен колонок для установки значения (разделены запятыми).
            Если параметр не указан или передана пустая строка, будут заполнены все колонки *Необязательный*. 
...
* **offset**: Количество строк, на которое сдвигается строка.
            Если значение положительное - сдвиг вниз, иначе вверх
...
* **columnNames**: Строка - Имена колонок для копирования, разделены запятыми
            Если параметр не указан или передана пустая строка, будут скопированы все колонки *Необязательный*. 
