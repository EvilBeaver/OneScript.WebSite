...
Функция СодержимоеСтраницыКонтента(Знач ПутьККонтенту) Экспорт
	...
	Исключение
		Значение = "<pre>" + ОписаниеОшибки() + "</pre>";
	КонецПопытки;
...
Функция ОписаниеСтраницыРаздела(ОписаниеРаздела, Страница) Экспорт
	Если Страница = "index" и ОписаниеРаздела.Строки.Количество() Тогда
		ОписаниеСтраницы = ОписаниеРаздела.Строки[0];
	Иначе
		ОписаниеСтраницы = ОписаниеРаздела.Строки.Найти(Страница, "Имя", Истина);
	КонецЕсли;
